...
func TestGenerateReportUseCase_AggregatesResultSampleCoCAndLocation(t *testing.T) {
	...
	sample := domainsample.Sample{ID: "SMP-2569-00001", Name: "Blood Sample", LocationID: &locationID}
	...
	uc := applicationtestresult.NewGenerateReportUseCase(results, samples, coc, locations)
...
func TestGenerateReportUseCase_NoLocationAssigned(t *testing.T) {
	...
	sample := domainsample.Sample{ID: "SMP-2569-00002", Name: "Blood Sample"}
