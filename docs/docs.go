...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/partner-devices": {
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/internal_adapters_http_partnerdevice.PartnerDeviceResponse"
                                            }
                                        }
                                    }
                                }
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "ข้อมูล Partner Device",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_adapters_http_partnerdevice.CreatePartnerDeviceRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/partner-devices/discover": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "จำนวนต่อหน้า (default 20, max 100)",
                        "name": "limit",
                        "in": "query"
                    }
                ],
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/internal_adapters_http_partnerdevice.DiscoverDevicesResponse"
                                        }
                                    }
                                }
                            ]
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_adapters_http_partnerdevice.UpdatePartnerDeviceRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/partner-devices/{serial}/snapshot": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/internal_adapters_http_partnerdevice.SnapshotResponse"
                                        }
                                    }
                                }
                            ]
    ...
    "definitions": {
        ...
        "internal_adapters_http_partnerdevice.CreatePartnerDeviceRequest": {
            "type": "object",
            "required": [
                "location",
                "serial"
        ...
        "internal_adapters_http_partnerdevice.DiscoverDeviceResponse": {
            "type": "object",
            "properties": {
                "firmware": {
                    "type": "string"
        ...
        "internal_adapters_http_partnerdevice.DiscoverDevicesResponse": {
            "type": "object",
            "properties": {
                "devices": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_adapters_http_partnerdevice.DiscoverDeviceResponse"
                    }
                },
                "limit": {
                    "type": "integer"
        ...
        "internal_adapters_http_partnerdevice.PartnerDeviceResponse": {
            "type": "object",
            "properties": {
                "active": {
                    "type": "boolean"
        ...
        "internal_adapters_http_partnerdevice.SnapshotResponse": {
            "type": "object",
            "properties": {
                "fetched_at": {
                    "type": "string"
        ...
        "internal_adapters_http_partnerdevice.UpdatePartnerDeviceRequest": {
            "type": "object",
            "required": [
                "location"
            ],
